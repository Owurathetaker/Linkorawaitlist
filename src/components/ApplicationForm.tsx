...
export default function ApplicationForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSubmitted(true);
      setMsg(
        "Application received.\n\nYou're now in the Gildra founding circle.\n\nWe carefully review every submission to maintain quality.\n\nIf approved, you'll receive your founding member invite."
      );
  ...
  return (
    ...
    >
      ...
      {submitted && msg ? (
        <div className="mt-8 rounded-3xl border border-green-200 bg-green-50 p-6 text-center md:p-8">
          <div className="text-2xl font-semibold tracking-tight text-green-800">
            Application received ✅
          </div>

          <p className="mt-4 whitespace-pre-line text-sm leading-7 text-green-800">
            {msg}
          </p>
        </div>
      ) : (
          ...
          <div className="space-y-5">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                ...
                and will not be shared publicly without your consent.
              </p>
            </div>
